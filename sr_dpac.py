...
for fits_file in stars_files:
    ...
    # #     print(err_list[3])
    #
    # sf.generate_stats_table(stat_list, name=name, ext='Table', folder_path='./stars/imgs/avg')

    # sf.show_telescopes(final_imgs, amp_max, name, save=False, folder_path='./stars/imgs/avg')

    print("All Telescope Features Acquired")
    print("---------------------------------------------")
    ####################################################################################################################
    master_img = sf.final_stitcher(final_imgs, distance=7, exp_fwhm=5, flux_min=0,
                                   th=th_list[file_counter - 1], peak_min=0)
...
# ####################################################################################################################
# # %%
# sf.print_fwhm(centroid_x_list, name2_list, save=True, name='avg_three', ext='cx_files', title='Centroid x',
#               folder_path='./stars/imgs/avg/',
#               xlabel='files', ylabel='x centroid')
# sf.print_fwhm(centroid_y_list, name2_list, save=True, name='avg_three', ext='cy_files', title='Centroid y',
#               folder_path='./stars/imgs/avg/',
#               xlabel='files', ylabel='y centroid')
# sf.print_centroid(sigma_list, sigma_list_s, names=name_list, save=True, name='avg_three', ext='sigma_files',
#                   title='Sigma',
#                   folder_path='./stars/imgs/avg/',
#                   xlabel='files', ylabel='sigma')
# sf.print_centroid(amp_list, amp_list_s, names=name_list, save=True, name='avg_three', ext='amp_files',
#                   title='Maximum Amplitude',
#                   folder_path='./stars/imgs/avg/',
#                   xlabel='files', ylabel='maximum amplitude')
# sf.print_centroid(dist_list, dist_list_s, names=name2_list, save=True, name='avg_three', ext='dist_files',
#                   title='Distance Two Brightest Stars',
#                   folder_path='./stars/imgs/avg/',
#                   xlabel='files', ylabel='distance')
# sf.print_centroid(ang_list, ang_list_s, names=name2_list, save=True, name='avg_three', ext='ang_files',
#                   title='Angle Two Brightest Stars',
#                   folder_path='./stars/imgs/avg/',
#                   xlabel='files', ylabel='angle')
# sf.print_centroid(dist2_list, dist2_list_s, names=name2_list, save=True, name='avg_three', ext='dist_files_',
#                   title='Distance Second and Third Brightest',
#                   folder_path='./stars/imgs/avg/',
#                   xlabel='files', ylabel='distance')
# sf.print_centroid(ang2_list, ang2_list_s, names=name2_list, save=True, name='avg_three', ext='ang_files_',
